...
| `inlayHints` | object | enabled | Inferred types and parameter names drawn between characters, from the language server (`enabled`). Servers that offer none cost nothing. |
